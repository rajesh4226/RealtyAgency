...
function GetPropertyDetails(propertyID, propUrl, viewType) {
    ...
    $.ajax({
        url: `${baseUri}/ForSell/Details/${propertyID}/${propUrl}/${viewType}/?isModal=true`,
        type: "get",
        success: function (response) {
            $('#propDetails').html(response);
            $('#staticBackdrop').modal('show');
            window.history.pushState('1', "Property Details", `${baseUri}/ForSell/Details/${propertyID}/${propUrl}/${viewType}/`);
        },
        error: function () {
