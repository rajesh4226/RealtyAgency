function GetPropertyData(isPagination) {
    ...
    $.ajax({
        url: `${baseUri}/ForSell/GetPropertyListAjaxMapView/?IsPagination=` + isPagination + "&" + urlparts[1],
        type: "get",
...
function GetPropertyMapData(isPagination) {
    ...
    let urlparts = url.split("?");
    $.ajax({
        url: `${baseUri}/ForSell/GetPropertyListAjaxMapData/?IsPagination=` + isPagination + "&" + urlparts[1],
        type: "get",
        success: function (response) {
