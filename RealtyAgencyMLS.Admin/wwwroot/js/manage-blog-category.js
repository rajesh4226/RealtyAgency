$(document).ready(function () {
    ...
    var table = $('#tblBlogCategories')
        .DataTable({
            "sAjaxSource": `${baseUri}/BlogCategory/GetAllCategory/`,
            "bServerSide": true,
            "bProcessing": true,
            "responsive": true,
            "bSearchable": true,
    ...
    $("#Refresh").click(function (e) {
        $('#tblBlogCategories').DataTable().ajax.reload(null, false);
    });
    ...
    $(document)
        ...
        .on('click', '.btnEdit', function () {
            ...
            $.ajax({
                url: `${baseUri}/BlogCategory/Edit/${id}`,
                type: 'GET',
                cache: false,
                contentType: false,
                processData: false,
    ...
    $(document)
        ...
        .on('click', '#btnCreate', function (e) {
            ...
            $.ajax({
                url: `${baseUri}/BlogCategory/Create`,
                type: 'POST',
                cache: false,
                contentType: false,
                processData: false,
    ...
    $(document)
        ...
        .on('click', '.btnDelete', function () {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        url: `${baseUri}/BlogCategory/Delete/${id}`,
                        type: 'POST',
                        cache: false,
                        contentType: false,
                        processData: false,
